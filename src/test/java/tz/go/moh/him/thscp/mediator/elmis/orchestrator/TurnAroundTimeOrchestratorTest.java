 ...
 */
public class TurnAroundTimeOrchestratorTest extends BaseOrchestratorTest {
    /**
     * Represents the orchestrator.
     */
    private final ActorRef orchestrator = system.actorOf(Props.create(TurnAroundTimeOrchestrator.class, configuration));
    ...
    @Before
    public void before() {
        setupDestinationMock(Constants.TURN_AROUND_TIME_REQUEST);
    }

    @Test
    public void testMediatorHTTPRequest() throws Exception {
        InputStream stream = TurnAroundTimeOrchestratorTest.class.getClassLoader().getResourceAsStream("turn_around_time_request.json");
